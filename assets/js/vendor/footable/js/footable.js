        ...
        ft.addRowToggle = function () {
            ...
            for (var c in ft.columns) {
                ...
                if (col.toggle) {
                    ...
                    var selector = '> tbody > tr:not(.' + cls.detail + ',.' + cls.disabled + ') > td:nth-child(' + (parseInt(col.index1, 10) + 1) + '),' +
                                            '> tbody > tr:not(.' + cls.detail + ',.' + cls.disabled + ') > th:nth-child(' + (parseInt(col.index1, 10) + 1) + ')';
